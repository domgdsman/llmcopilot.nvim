...
local ns_id = vim.api.nvim_create_namespace 'llmcopilot'
...
local group = vim.api.nvim_create_augroup('LLM_COPILOT_AutoGroup', { clear = true })
...
function M.invoke_llm_and_stream_into_editor(opts, make_curl_args_fn, handle_data_fn)
  ...
  vim.api.nvim_set_keymap('n', '<Esc>', ':doautocmd User LLM_COPILOT_Escape<CR>', { noremap = true, silent = true })
  return active_job
end
